...
function manualData() {
  ...
  for (const [key, value] of Object.entries({ groupId: "11111111-1111-4111-8111-111111111111", firstName: "Test", lastName: "Persona", birthDate: "1990-01-02", email: "synthetic@example.org", phone: "+39 333 1234567", availabilityUnknown: "on", consentConfirmed: "on" })) data.set(key, value);
  return data;
}
