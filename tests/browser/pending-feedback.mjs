...
try {
  ...
  delayed('document.querySelector("[data-statistics]").click()', 'document.querySelector("[data-statistics] [data-link-pending]") && getComputedStyle(document.querySelector("[data-statistics]")).cursor!=="wait"', '!document.querySelector("[data-link-pending]") && document.querySelector("[data-section]").textContent==="statistics"', "statistics query navigation starts and clears overlay");
  delayed('document.querySelector("[data-groups]").click()', 'document.querySelector("[data-groups] [data-link-pending]")', '!document.querySelector("[data-link-pending]") && document.querySelector("[data-section]").textContent==="groups"', "second navigation starts and clears overlay");
  ab("eval", 'document.querySelector("[data-cancel]").click()'); check('!document.querySelector("[data-link-pending]")', "cancelled click does not start overlay");
  ...
  delayed('document.querySelector("[data-save]").click()', 'document.querySelector("[data-save]").disabled && document.querySelector("[data-save] .button-progress-overlay").dataset.state==="pending"', '!document.querySelector("[data-save]").disabled && document.querySelector("[data-saved]").textContent==="1"', "validated save shows overlay until completion");
