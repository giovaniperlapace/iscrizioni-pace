...
export const messages: Record<SupportedLocale, PublicMessages> = {
  it: {
    ...
    confirmation: {
      ...
      bodyAfterEmail: `Per accedere alla tua area personale, inserisci lo stesso indirizzo email nella pagina iniziale. ${EMAIL_DELIVERY_COPY.it.checkSpam} ${EMAIL_DELIVERY_COPY.it.safeSender}`,
      backHome: "Vai alla pagina iniziale per accedere",
    },
    registrationClosed: {
  ...
  en: {
    ...
    confirmation: {
      ...
      title: "Thank you",
      bodyBeforeEmail: "We have received your registration and sent a confirmation to",
      fallbackEmail: "your email address",
      bodyAfterEmail: `To access your dashboard, enter the same email address on the home page. ${EMAIL_DELIVERY_COPY.en.checkSpam} ${EMAIL_DELIVERY_COPY.en.safeSender}`,
      backHome: "Go to the home page to sign in",
    },
    registrationClosed: {
  ...
  fr: {
    ...
    confirmation: {
      ...
      fallbackEmail: "ton adresse e-mail",
      bodyAfterEmail: `Pour accéder à ton espace personnel, saisis la même adresse e-mail sur la page d'accueil. ${EMAIL_DELIVERY_COPY.fr.checkSpam} ${EMAIL_DELIVERY_COPY.fr.safeSender}`,
      backHome: "Aller à l'accueil pour se connecter",
    },
    registrationClosed: {
  ...
  de: {
    ...
    confirmation: {
      ...
      title: "Danke",
      bodyBeforeEmail: "Wir haben deine Anmeldung erhalten. Eine Bestätigung haben wir an folgende Adresse gesendet:",
      fallbackEmail: "deine E-Mail-Adresse",
      bodyAfterEmail: `Um deinen persönlichen Bereich zu öffnen, gib auf der Startseite dieselbe E-Mail-Adresse ein. ${EMAIL_DELIVERY_COPY.de.checkSpam} ${EMAIL_DELIVERY_COPY.de.safeSender}`,
      backHome: "Zur Startseite und anmelden",
    },
    registrationClosed: {
      title: "Die Anmeldung ist derzeit geschlossen",
  ...
  es: {
    ...
    confirmation: {
      ...
      fallbackEmail: "tu dirección de correo electrónico",
      bodyAfterEmail: `Para acceder a tu área personal, introduce la misma dirección de correo electrónico en la página de inicio. ${EMAIL_DELIVERY_COPY.es.checkSpam} ${EMAIL_DELIVERY_COPY.es.safeSender}`,
      backHome: "Ir al inicio para acceder",
    },
    registrationClosed: {
      title: "Las inscripciones están cerradas en este momento",
  ...
  nl: {
    ...
    confirmation: {
      ...
      fallbackEmail: "je e-mailadres",
      bodyAfterEmail: `Vul op de startpagina hetzelfde e-mailadres in om je persoonlijke pagina te openen. ${EMAIL_DELIVERY_COPY.nl.checkSpam} ${EMAIL_DELIVERY_COPY.nl.safeSender}`,
      backHome: "Ga naar de startpagina om in te loggen",
    },
    registrationClosed: {
      title: "De inschrijving is momenteel gesloten",
  ...
  uk: {
    ...
    confirmation: {
      ...
      bodyAfterEmail: `Щоб увійти до особистого кабінету, введіть ту саму адресу електронної пошти на головній сторінці. ${EMAIL_DELIVERY_COPY.uk.checkSpam} ${EMAIL_DELIVERY_COPY.uk.safeSender}`,
      backHome: "Перейти на головну сторінку, щоб увійти",
    },
    registrationClosed: {
      title: "Реєстрацію не відкрито",
      body: "Наразі немає опублікованої події з відкритою реєстрацією.",
      groupLinkError: "Посилання для реєстрації у групі недійсне або більше не активне.",
    },
  },
};
