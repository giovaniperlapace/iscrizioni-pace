import { BIRTH_DATE_COPY } from "../registrations/birth-date-copy.ts";
import type { SupportedLocale } from "../i18n/config.ts";

const en = {
  birthDateReview: BIRTH_DATE_COPY.en.confirm,
  ...
  phone: "Include the international prefix, for example +39 333 1234567. Start with + followed by 7–15 digits.",
  date: "Enter a valid date and check the date order.", attendance: "Select at least one attendance slot or choose to confirm later.",
  consent: "Confirm that you have the person's consent.", children: "Enter the number of children, from 1 to 10.",
  group: "Select an available group.", tooLong: "Shorten this value to the indicated limit.",
  invalid: "Check the format and limits of this field.", duplicateEmail: "This email already belongs to a registration or account. Check the address.",
  duplicate: "This item already exists. Check the existing entry.", forbidden: "You do not have permission to save this change.",
  closed: "Changes to this registration are closed.", failed: "We could not save. Your entries have been kept. Check your connection and try again.",
};
export const FORM_COPY: Record<SupportedLocale, typeof en> = {
  en,
  it: {
    birthDateReview: BIRTH_DATE_COPY.it.confirm,
    ...
    date: "Inserisci una data valida e controlla l'ordine delle date.", attendance: "Seleziona almeno una fascia di presenza oppure indica che la confermerai più avanti.",
    consent: "Conferma di avere il consenso della persona.", children: "Indica il numero di figli, da 1 a 10.", group: "Seleziona un gruppo disponibile.",
    tooLong: "Riduci il testo entro il limite indicato.", invalid: "Controlla il formato e i limiti di questo campo.", duplicateEmail: "Questa email è già associata a un'iscrizione o a un account. Controlla l'indirizzo.",
    duplicate: "Questo elemento esiste già. Controlla la voce esistente.", forbidden: "Non hai i permessi per salvare questa modifica.", closed: "Le modifiche a questa iscrizione sono chiuse.",
    failed: "Salvataggio non riuscito. I dati inseriti sono stati conservati. Controlla la connessione e riprova.",
  },
  fr: {
    birthDateReview: BIRTH_DATE_COPY.fr.confirm,
  ...
  de: {
    birthDateReview: BIRTH_DATE_COPY.de.confirm,
  ...
  es: {
    birthDateReview: BIRTH_DATE_COPY.es.confirm,
  ...
  nl: {
    birthDateReview: BIRTH_DATE_COPY.nl.confirm,
  ...
  uk: {
    birthDateReview: BIRTH_DATE_COPY.uk.confirm,
