...
export const MANUAL_REGISTRATION_COPY = {
  "it": {
    ...
    "manualHelp": "Aggiungi una persona direttamente a uno dei gruppi che gestisci. La persona risulta subito confermata nel gruppo scelto.",
    "group": "Gruppo",
  ...
  "en": {
    ...
    "manualHelp": "Add a person directly to one of the groups you manage. The person is immediately confirmed in the selected group.",
    "group": "Group",
  ...
  "fr": {
    ...
    "manualHelp": "Ajoute une personne directement à l'un des groupes que tu gères. La personne est immédiatement confirmée dans le groupe choisi.",
    "group": "Groupe",
  ...
  "de": {
    ...
    "manualHelp": "Füge eine Person direkt zu einer der Gruppen hinzu, die du verwaltest. Die Person ist sofort in der ausgewählten Gruppe bestätigt.",
    "group": "Gruppe",
  ...
  "es": {
    ...
    "manualHelp": "Añade una persona directamente a uno de los grupos que gestionas. La persona queda inmediatamente confirmada en el grupo elegido.",
    "group": "Grupo",
  ...
  "nl": {
    ...
    "manualHelp": "Voeg een persoon rechtstreeks toe aan een van de groepen die je beheert. De persoon is meteen bevestigd in de gekozen groep.",
    "group": "Groep",
  ...
  "uk": {
    ...
    "manualHelp": "Додайте людину безпосередньо до однієї з груп, якими ви керуєте. Людина одразу буде підтверджена у вибраній групі.",
    "group": "Група",
...
export type ManualRegistrationCopy = typeof MANUAL_REGISTRATION_COPY[SupportedLocale];
