...
export const SELF_CANCELLATION_COPY: Record<SupportedLocale, CancellationCopy> = {
  it: {
    ...
    history: "I dati già registrati saranno conservati nello storico. Il tuo account ed eventuali incarichi come referente o operatore resteranno attivi.",
  ...
  en: {
    ...
    history: "Previously recorded data will be retained in the history. Your account and any group leader or operational roles will remain active.",
  ...
  fr: {
    ...
    history: "Les données déjà enregistrées seront conservées dans l’historique. Votre compte et vos éventuels rôles de responsable de groupe ou d’opérateur resteront actifs.",
  ...
  de: {
    ...
    history: "Bereits erfasste Daten bleiben im Verlauf gespeichert. Ihr Konto sowie etwaige Gruppenleitungs- oder operative Rollen bleiben aktiv.",
  ...
  es: {
    ...
    history: "Los datos ya registrados se conservarán en el historial. Tu cuenta y tus posibles funciones de responsable de grupo u operador seguirán activas.",
  ...
  nl: {
    ...
    history: "Eerder vastgelegde gegevens blijven in de geschiedenis bewaard. Je account en eventuele rollen als groepsleider of medewerker blijven actief.",
  ...
  uk: {
    ...
    history: "Раніше внесені дані залишаться в історії. Ваш обліковий запис і можливі ролі керівника групи або оператора залишаться активними.",
